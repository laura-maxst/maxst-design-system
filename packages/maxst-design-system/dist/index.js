...
var TitleTagFilter = function (_a) {
    var role = _a.role, className = _a.className, children = _a.children;
    switch (role) {
        case 1:
            return React__default["default"].createElement("h1", { className: className }, children);
        case 2:
            return React__default["default"].createElement("h2", { className: className }, children);
        case 3:
            return React__default["default"].createElement("h3", { className: className }, children);
        case 4:
            return React__default["default"].createElement("h4", { className: className }, children);
        case 5:
            return React__default["default"].createElement("h5", { className: className }, children);
        case 6:
            return React__default["default"].createElement("h6", { className: className }, children);
        default:
            return React__default["default"].createElement("h1", { className: className }, children);
    }
};
...
function Title(_a) {
    var role = _a.role, _b = _a.type, type = _b === void 0 ? 'title' : _b, size = _a.size, align = _a.align, className = _a.className, children = _a.children;
    return (React__default["default"].createElement(TitleTagFilter, { role: role, className: [
            'font-title',
            "font-".concat(type, "-").concat(size),
            align ? align : '',
            className ? className : '',
        ].join(' ') }, children));
}
...
var CalibrationLineIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.928 7.01941H5.967V30.951H13.928V7.01941ZM11.5276 28.5506H8.3674V9.41981H11.5276V28.5506ZM27.8896 20.1436H20.0974V21.3964L15.921 18.9852L20.0974 16.574V17.7432H27.8896V16.574L32.066 18.9852L27.8896 21.3964V20.1436ZM33.8488 40.6461H39.6026V34.7341H42.003V43.0465H5.967V34.7341H8.3672V40.6461H14.7316V36.9987H17.132V40.6461H22.8214V34.7341H25.2218V40.6461H31.4484V36.9987H33.8488V40.6461ZM34.0425 30.951V7.01941H42.0035V30.951H34.0425ZM36.4429 28.5506H39.6031V9.41981H36.4429V28.5506Z", fill: "currentColor" })));
};

var CalibrationLineBoldIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M14.2276 5.6322H5.66701V30.1634H14.2276V5.6322ZM11.2276 27.1634H8.66701V8.6322H11.2276V27.1634ZM27.8896 19.3548H20.0974V20.3089L15.921 17.8977L20.0974 15.4865V16.3548H27.8896V15.4865L32.066 17.8977L27.8896 20.3089V19.3548ZM34.1486 39.2591H39.3028V33.6459H42.3028V42.2591H5.66701V33.6459H8.66701V39.2591H14.4318V35.9115H17.4318V39.2591H22.5216V33.6459H25.5216V39.2591H31.1486V35.9115H34.1486V39.2591ZM42.3031 30.1634H33.7425V5.6322H42.3031V30.1634ZM39.3031 8.6322H36.7425V27.1634H39.3031V8.6322Z", fill: "currentColor" })));
};

var CalibrationLineLightIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.3418 6.58691H6.582V29.3163H13.3418V6.58691ZM12.1426 28.1171H7.7812V7.78611H12.1426V28.1171ZM28.7816 18.509H19.3934V19.948L15.936 17.9518L19.3934 15.9556V17.3098H28.7816V16.047L32.081 17.9518L28.7816 19.8566V18.509ZM33.2626 40.2139H40.2176V33.7013H41.4168V41.4131H6.582V33.7013H7.7812V40.2139H15.3466V35.9659H16.5458V40.2139H23.4364V33.7013H24.6356V40.2139H32.0634V35.9659H33.2626V40.2139ZM41.4173 29.3163H34.6575V6.58691H41.4173V29.3163ZM40.2181 7.78611H35.8567V28.1171H40.2181V7.78611Z", fill: "currentColor" })));
};

var CalibrationFillIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13
619 19.8749C37.4619 19.6549 37.4819 19.4349 37.5219 19.2349V19.2245L26.5039 13.2955C25.8275 13.9299 24.9245 14.3263 23.9255 14.3263C22.9271 14.3263 22.0243 13.9299 21.3481 13.2951L10.3203 19.2303C10.3207 19.2319 10.3219 19.2333 10.3221 19.2351C10.3621 19.4351 10.3821 19.6551 10.3821 19.8751C10.3821 20.0951 10.3621 20.3151 10.3221 20.5151L16.5221 23.8351L23.9221 19.8551ZM39.8621 19.8751C39.8621 20.6351 40.4821 21.2551 41.2421 21.2551C42.0021 21.2551 42.6221 20.6351 42.6221 19.8751C42.6221 19.0951 42.0021 18.4951 41.2421 18.4951C40.4821 18.4951 39.8621 19.0951 39.8621 19.8751ZM30.0625 29.9751L33.8625 27.9351L36.4025 26.5551L43.7825 30.5351L23.9225 41.2351L4.08252 30.5351L11.4625 26.5551L14.0025 27.9351L17.8025 29.9751C18.1825 33.0151 20.7825 35.3751 23.9225 35.3751C27.0825 35.3751 29.6825 33.0151 30.0625 29.9751Z", fill: "currentColor" })));
};
...
var FindInPageLineIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M12.0028 6.80017H41.1998V24.5H38.7998V9.20017H12.9969L9.19982 12.9972V38.8H25.9998V41.2H6.79982V12.0031L12.0028 6.80017ZM33.7647 28.2C31.2437 28.2 29.2 30.2437 29.2 32.7647C29.2 35.2857 31.2437 37.3294 33.7647 37.3294C36.2857 37.3294 38.3294 35.2857 38.3294 32.7647C38.3294 30.2437 36.2857 28.2 33.7647 28.2ZM26.8 32.7647C26.8 28.9182 29.9182 25.8 33.7647 25.8C37.6112 25.8 40.7294 28.9182 40.7294 32.7647C40.7294 34.0282 40.393 35.213 39.8048 36.2346L43.6969 40.1266L42 41.8238L38.2604 38.0843C37.0472 39.1106 35.4782 39.7294 33.7647 39.7294C29.9182 39.7294 26.8 36.6112 26.8 32.7647ZM14 19L34 19L34 16.6L14 16.6V19ZM26 24H14V21.6H26V24ZM14 28.9999H22V26.5999H14V28.9999Z", fill: "currentColor" })));
};

var FindInPageLineBoldIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M11.8785 6.50012H41.4998V24.4999H38.4998V9.50012H13.1211L9.49981 13.1214V38.4999H25.9998V41.4999H6.49981V11.8788L11.8785 6.50012ZM33.7647 28.5C31.4094 28.5 29.5 30.4094 29.5 32.7647C29.5 35.12 31.4094 37.0294 33.7647 37.0294C36.12 37.0294 38.0294 35.12 38.0294 32.7647C38.0294 30.4094 36.12 28.5 33.7647 28.5ZM26.5 32.7647C26.5 28.7525 29.7525 25.5 33.7647 25.5C37.7769 25.5 41.0294 28.7525 41.0294 32.7647C41.0294 33.8878 40.7745 34.9513 40.3195 35.9007L44.1211 39.7023L42 41.8238L38.4732 38.2971C37.2052 39.3774 35.5611 40.0294 33.7647 40.0294C29.7525 40.0294 26.5 36.7769 26.5 32.7647ZM14 19.3L34 19.3001L34 16.3001L14 16.3V19.3ZM26 24.5H14V21.5H26V24.5ZM14 29.2998H22V26.2998H14V29.2998Z", fill: "currentColor" })));
};

var FindInPageLineLightIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M
}),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M33.7002 39.5002H13.7002V38.3002H33.7002V39.5002Z", fill: "currentColor" })));
};

var IdCardFillIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M18.3502 10.228H13.5563L9.20056 15.3142V42.7795H38.239V10.228H29.0502V13V14.2H27.8502H19.5502H18.3502V13V10.228ZM20.7502 10.228V11.8H21.2045V10.228H20.7502ZM26.0442 11.8V10.228H26.6502V11.8H26.0442ZM23.6998 19.2002C22.4295 19.2002 21.3998 20.2299 21.3998 21.5002C21.3998 22.7705 22.4295 23.8002 23.6998 23.8002C24.97 23.8002 25.9998 22.7705 25.9998 21.5002C25.9998 20.2299 24.97 19.2002 23.6998 19.2002ZM18.9998 21.5002C18.9998 18.9045 21.104 16.8002 23.6998 16.8002C26.2955 16.8002 28.3998 18.9045 28.3998 21.5002C28.3998 24.0959 26.2955 26.2002 23.6998 26.2002C21.104 26.2002 18.9998 24.0959 18.9998 21.5002ZM17.9006 30.9448C17.9006 30.1446 18.5772 29.31 19.6603 29.1339L22.8936 32.0717L23.7006 32.805L24.5075 32.0717L27.7409 29.1339C28.8239 29.31 29.5006 30.1446 29.5006 30.9448V35.9H31.9006V30.9448C31.9006 28.4851 29.7226 26.7 27.3144 26.7H26.8506L26.5074 27.0119L23.7006 29.5622L20.8937 27.0119L20.5505 26.7H20.0867C17.6786 26.7 15.5006 28.4851 15.5006 30.9448V35.9H17.9006V30.9448ZM33.6998 40.0002H13.6998V37.6002H33.6998V40.0002Z", fill: "currentColor" }),
        React.createElement("rect", { x: "20.1986", y: "3.70007", width: "6.9", height: "9", fill: "currentColor" })));
};

var IdCardFillLightIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M19.6986 10.2283H13.5563L9.20056 15.3144V42.7798H38.239V10.2283H27.6986V13.8002H19.6986V10.2283ZM23.7002 19.1003C22.0985 19.1003 20.8002 20.3987 20.8002 22.0003C20.8002 23.602 22.0985 24.9003 23.7002 24.9003C25.3018 24.9003 26.6002 23.602 26.6002 22.0003C26.6002 20.3987 25.3018 19.1003 23.7002 19.1003ZM19.6002 22.0003C19.6002 19.736 21.4358 17.9003 23.7002 17.9003C25.9645 17.9003 27.8002 19.736 27.8002 22.0003C27.8002 24.2647 25.9645 26.1003 23.7002 26.1003C21.4358 26.1003 19.6002 24.2647 19.6002 22.0003ZM17.3002 29.945C17.3002 28.7155 18.3782 27.6095 19.8628 27.5078L23.2967 30.6279L23.7002 30.9945L24.1037 30.6279L27.5375 27.5078C29.0222 27.6095 30.1002 28.7155 30.1002 29.945V34.9002H31.3002V29.945C31.3002 27.8751 29.4524 26.3002 27.314 26.3002H27.0821L26.9105 26.4562L23.7002 29.3731L20.4898 26.4562L20.3182 26.3002H20.0864C17.948 26.3002 16.1002 27.8751 16.1002 29.945V34.9002H17.3002V29.945ZM33.7002 39.5003H13.7002V38.3003H33.7002V39.5003Z", fill: "currentColor" }),
        React.createElement("rect", { x: "20.7201", y: "5.00024", width: "6", height: "8", fill: "currentColor" })));
};
...
var LayerHorizontalFillIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("g", { clipPath: "url(#clip0_2227_254)" },
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M24.4941 44.3702L8.2472 32.4943L7.99976 12.3712L24.2467 24.2471L24.4941 44.3702ZM32.4939 40.2466L26.7401 36.0685L26.5577 23.0558L16.0646 15.358L15.9995 8.2476L32.2464 20.1235L32.4939 40.2466ZM34.7405 31.9445L40.4943 36.1226L40.2469 15.9995L23.9999 4.12364L24.065 11.2341L34.5582 18.9319L34.7405 31.9445Z", fill: "currentColor" })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "clip0_2227_254" },
                React.createElement("rect", { width: "48", height: "48", fill: "white" })))));
};
...
var SlamLineIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M35.3018 12.5149V25.5647L24 32.0901L12.6982 25.5647V12.5149L24 5.9895L35.3018 12.5149ZM25.2002 19.7315V28.6257L32.9014 24.1799V15.2853L25.2002 19.7315ZM32.8348 13.8613L32.9014 13.9767V13.8997L32.8348 13.8613ZM24 17.6541L31.702 13.2073L24 8.7611L16.298 13.2073L24 17.6541ZM15.0988 13.9767L15.1654 13.8613L15.0988 13.8997V13.9767ZM22.8 19.7315L15.0988 15.2853V24.1799L22.8 28.6257V19.7315ZM39.799 34.1067H42.1994L42.2004 42.4191H5.79999V34.1067H8.20039V40.0187H14.7316V36.3713H17.132V40.0187H22.8214V34.1067H25.2218V40.0187H31.4484V36.3713H33.8488V40.0187H39.8L39.799 34.1067Z", fill: "currentColor" })));
};

var SlamLineBoldIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M35.6016 11.9696V25.3642L24 32.0634L12.3984 25.3642V11.9696L24 5.27039L35.6016 11.9696ZM25.5 19.5328V27.7328L32.6016 23.6338V15.4334L25.5 19.5328ZM24 16.935L31.1028 12.835L24 8.73519L16.8972 12.835L24 16.935ZM22.5 19.5328L15.3984 15.4334V23.6338L22.5 27.7328V19.5328ZM39.4992 33.7334H42.4992L42.5002 42.3466H5.50021V33.7334H8.50021V39.3466H14.4318V35.999H17.4318V39.3466H22.5216V33.7334H25.5216V39.3466H31.1486V35.999H34.1486V39.3466H39.5002L39.4992 33.7334Z", fill: "currentColor" })));
};

var SlamLineLightIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M34.7012 12.4889V24.8463L24 31.0241L13.2988 24.8463V12.4889L24 6.31006L34.7012 12.4889ZM24.5996 19.0141V29.2931L33.502 24.1531V13.8745L24.5996 19.0141ZM24 17.9749L32.9018 12.8357L24 7.69486L15.0982 12.8357L24 17.9749ZM23.4006 19.0139L14.4982 13.8743V24.1527L23.4006 29.2929V19.0139ZM40.3996 33.7349H41.5988L41.5998 41.4469H6.40042V33.7349H7.59982V40.2477H15.3322V35.9995H16.5314V40.2477H23.422V33.7349H24.6212V40.2477H32.049V35.9995H33.2482V40.2477H40.4004L40.3996 33.7349Z", fill: "currentColor" })));
};

var SlamFillIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M34.1012 11.4504L23.9994 17.2818L13.8984 11.4498L23.9994 5.61719L34.1012 11.4504ZM12.6986 13.5276L22.8002 19.3598V31.0252L12.6986 25.1924V13.5276ZM25.1986 19.3598V31.0252L35.3002 25.1924V13.5286L25.1986 19.3598ZM39.8002 39.6464V33.7344H42.1986V42.0468H5.80017V33.7344H8.19857V39.6464H14.7318V35.999H17.1302V39.6464H22.8216V33.7344H25.22V39.6464H31.4486V35.999H33.847V39.6464H39.8002Z", fill: "currentColor" })));
};
...
var ViewInArLineIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        ...
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M24.0001 10.2455L36.7001 16.8956V31.3953L24.0001 38.0455L11.3001 31.3953V16.8956L24.0001 10.2455ZM13.7001 19.4547V29.9429L22.8001 34.708V23.4257L13.7001 19.4547ZM25.2001 23.4257V34.708L34.3001 29.9429V19.4547L25.2001 23.4257ZM32.7253 17.5234L24.0001 21.3307L15.2749 17.5234L24.0001 12.9546L32.7253 17.5234Z", fill: "currentColor" })));
};
...
var VpsLineIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M28.083 29.5725H19.917V32.2884H12.083V24.4554H14.7998V16.2924H12.083V8.45935H19.917V11.1722H28.083V8.45935H35.917V16.2924H33.2002V24.4554H35.917V32.2884H28.083V29.5725ZM30.4834 29.888H33.5166V26.8558H30.4834V29.888ZM33.5166 10.8596H30.4834V13.8918H33.5166V10.8596ZM17.5166 10.8596H14.4834V13.8918H17.5166V10.8596ZM19.917 16.2922H17.2002V24.4552H19.917V27.172H28.083V24.4552H30.7998V16.2922H28.083V13.5724H19.917V16.2922ZM14.4834 29.888H17.5166V26.8558H14.4834V29.888ZM39.799 34.1067H42.1994L42.2004 42.4191H5.79999V34.1067H8.20039V40.0187H14.7316V36.3713H17.132V40.0187H22.8214V34.1067H25.2218V40.0187H31.4484V36.3713H33.8488V40.0187H39.8L39.799 34.1067Z", fill: "currentColor" })));
};

var VpsLineBoldIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M27.7834 31.4991H20.217V34.2159H11.7834V25.7823H14.5002V18.2199H11.7834V9.78625H20.217V12.4991H27.7834V9.78625H36.217V18.2199H33.5002V25.7823H36.217V34.2159H27.7834V31.4991ZM30.7834 31.2159H33.217V28.7823H30.7834V31.2159ZM33.217 12.7863H30.7834V15.2199H33.217V12.7863ZM17.217 12.7863H14.7834V15.2199H17.217V12.7863ZM20.217 18.2199H17.5002V25.7823H20.217V28.4991H27.7834V25.7823H30.5002V18.2199H27.7834V15.4991H20.217V18.2199ZM14.7834 31.2159H17.217V28.7823H14.7834V31.2159ZM39.4992 35.7334H42.4992L42.5002 44.3466H5.50018V35.7334H8.50018V41.3466H14.4318V37.999H17.4318V41.3466H22.5216V35.7334H25.5216V41.3466H31.1486V37.999H34.1486V41.3466H39.5002L39.4992 35.7334Z", fill: "currentColor" })));
};

var VpsLineLightIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M28.6838 28.599H19.3166V31.3158H12.6838V24.683H15.4006V15.3198H12.6838V8.68701H19.3166V11.3998H28.6838V8.68701H35.3166V15.3198H32.5998V24.683H35.3166V31.3158H28.6838V28.599ZM29.883 30.1166H34.1174V25.8822H29.883V30.1166ZM34.1174 9.88621H29.883V14.1206H34.1174V9.88621ZM18.1174 9.88621H13.883V14.1206H18.1174V9.88621ZM19.3166 15.3198H16.5998V24.683H19.3166V27.3998H28.6838V24.683H31.4006V15.3198H28.6838V12.599H19.3166V15.3198ZM13.883 30.1166H18.1174V25.8822H13.883V30.1166ZM40.3996 33.7349H41.5988L41.5998 41.4469H6.40039V33.7349H7.59979V40.2477H15.3322V35.9995H16.5314V40.2477H23.422V33.7349H24.6212V40.2477H32.049V35.9995H33.2482V40.2477H40.4004L40.3996 33.7349Z", fill: "currentColor" })));
};

var VpsFillIcon = function () {
    return (React.createElement("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M35.9154 8.0802V15.92H33.1946V24.0802H35.9154V31.92H28.0776V29.2002H19.9154V31.92H12.0776V24.0802H14.7964V15.92H12.0776V8.0802H19.9154V10.8H28.0776V8.0802H35.9154ZM33.517 10.4806H30.476V13.5196H33.517V10.4806ZM14.476 10.4806V13.5196H17.517V10.4806H14.476ZM14.476 29.5196H17.517V26.4806H14.476V29.5196ZM33.517 29.5196V26.4806H30.476V29.5196H33.517ZM39.8002 39.6464V33.7344H42.1986V42.0468H5.8002V33.7344H8.1986V39.6464H14.7318V35.999H17.1302V39.6464H22.8216V33.7344H25.22V39.6464H31.4486V35.999H33.847V39.6464H39.8002Z", fill: "currentColor" })));
};
...
dist.ArScanLineBoldIcon = ArScanLineBoldIcon;
dist.ArScanLineIcon = ArScanLineIcon;
dist.ArScanLineLightIcon = ArScanLineLightIcon;
...
dist.ArrowBackwardLineLightIcon = ArrowBackwardLineLightIcon;
dist.ArrowDownCircleFillIcon = ArrowDownCircleFillIcon;
var ArrowDownCircleLineIcon_1 = dist.ArrowDownCircleLineIcon = ArrowDownCircleLineIcon;
...
dist.ArrowDownwardLineLightIcon = ArrowDownwardLineLightIcon;
...
dist.ArrowForwardLineLightIcon = ArrowForwardLineLightIcon;
dist.ArrowInwardLineBoldIcon = ArrowInwardLineBoldIcon;
dist.ArrowInwardLineIcon = ArrowInwardLineIcon;
dist.ArrowInwardLineLightIcon = ArrowInwardLineLightIcon;
...
dist.ArrowOutwardLineLightIcon = ArrowOutwardLineLightIcon;
...
dist.ArrowUpCircleLineIcon = ArrowUpCircleLineIcon;
...
dist.ArrowUpwardLineLightIcon = ArrowUpwardLineLightIcon;
dist.CalibrationFillIcon = CalibrationFillIcon;
dist.CalibrationLineBoldIcon = CalibrationLineBoldIcon;
dist.CalibrationLineIcon = CalibrationLineIcon;
dist.CalibrationLineLightIcon = CalibrationLineLightIcon;
...
dist.CloseLineLightIcon = CloseLineLightIcon;
dist.ContentCopyFillIcon = ContentCopyFillIcon;
dist.ContentCopyLineBoldIcon = ContentCopyLineBoldIcon;
dist.ContentCopyLineIcon = ContentCopyLineIcon;
dist.ContentCopyLineLightIcon = ContentCopyLineLightIcon;
dist.CurrencyFillIcon = CurrencyFillIcon;
dist.CurrencyLineBoldIcon = CurrencyLineBoldIcon;
dist.CurrencyLineIcon = CurrencyLineIcon;
dist.CurrencyLineLightIcon = CurrencyLineLightIcon;
...
dist.DigitalTwinFillIcon = DigitalTwinFillIcon;
dist.DigitalTwinLineBoldIcon = DigitalTwinLineBoldIcon;
dist.DigitalTwinLineIcon = DigitalTwinLineIcon;
dist.DigitalTwinLineLightIcon = DigitalTwinLineLightIcon;
...
dist.FileBinFillIcon = FileBinFillIcon;
dist.FileBinLineBoldIcon = FileBinLineBoldIcon;
dist.FileBinLineIcon = FileBinLineIcon;
dist.FileBinLineLightIcon = FileBinLineLightIcon;
dist.FileEfsFillIcon = FileEfsFillIcon;
dist.FileEfsLineBoldIcon = FileEfsLineBoldIcon;
dist.FileEfsLineIcon = FileEfsLineIcon;
dist.FileEfsLineLightIcon = FileEfsLineLightIcon;
dist.FileJpgFillIcon = FileJpgFillIcon;
dist.FileJpgLineBoldIcon = FileJpgLineBoldIcon;
dist.FileJpgLineIcon = FileJpgLineIcon;
dist.FileJpgLineLightIcon = FileJpgLineLightIcon;
dist.FileLineBoldIcon = FileLineBoldIcon;
dist.FileLineIcon = FileLineIcon;
dist.FileLineLightIcon = FileLineLightIcon;
dist.FileMoveFillIcon = FileMoveFillIcon;
dist.FileMoveLineBoldIcon = FileMoveLineBoldIcon;
dist.FileMoveLineIcon = FileMoveLineIcon;
dist.FileMoveLineLightIcon = FileMoveLineLightIcon;
dist.FileMp4FillIcon = FileMp4FillIcon;
dist.FileMp4LineBoldIcon = FileMp4LineBoldIcon;
dist.FileMp4LineIcon = FileMp4LineIcon;
dist.FileMp4LineLightIcon = FileMp4LineLightIcon;
dist.FilePlyFillIcon = FilePlyFillIcon;
dist.FilePlyLineBoldIcon = FilePlyLineBoldIcon;
dist.FilePlyLineIcon = FilePlyLineIcon;
dist.FilePlyLineLightIcon = FilePlyLineLightIcon;
dist.FileZipFillIcon = FileZipFillIcon;
dist.FileZipLineBoldIcon = FileZipLineBoldIcon;
dist.FileZipLineIcon = FileZipLineIcon;
dist.FileZipLineLightIcon = FileZipLineLightIcon;
dist.FilterFillIcon = FilterFillIcon;
dist.FilterLineBoldIcon = FilterLineBoldIcon;
dist.FilterLineIcon = FilterLineIcon;
dist.FilterLineLightIcon = FilterLineLightIcon;
dist.FindInPageFillIcon = FindInPageFillIcon;
dist.FindInPageLineBoldIcon = FindInPageLineBoldIcon;
dist.FindInPageLineIcon = FindInPageLineIcon;
dist.FindInPageLineLightIcon = FindInPageLineLightIcon;
dist.FirstPageLineBoldIcon = FirstPageLineBoldIcon;
var FirstPageLineIcon_1 = dist.FirstPageLineIcon = FirstPageLineIcon;
dist.FloorFillIcon = FloorFillIcon;
dist.FloorLineBoldIcon = FloorLineBoldIcon;
dist.FloorLineIcon = FloorLineIcon;
dist.FloorLineLightIcon = FloorLineLightIcon;
...
dist.GridViewFillIcon = GridViewFillIcon;
dist.GridViewLineBoldIcon = GridViewLineBoldIcon;
dist.GridViewLineIcon = GridViewLineIcon;
dist.GridViewLineLightIcon = GridViewLineLightIcon;
...
dist.IdCardFillIcon = IdCardFillIcon;
dist.IdCardFillLightIcon = IdCardFillLightIcon;
dist.IdCardLineBoldIcon = IdCardLineBoldIcon;
dist.IdCardLineIcon = IdCardLineIcon;
dist.IdCardLineLightIcon = IdCardLineLightIcon;
...
dist.LayerHorizontalFillIcon = LayerHorizontalFillIcon;
dist.LayerHorizontalLineBoldIcon = LayerHorizontalLineBoldIcon;
dist.LayerHorizontalLineIcon = LayerHorizontalLineIcon;
dist.LayerHorizontalLineLightIcon = LayerHorizontalLineLightIcon;
...
dist.MinusCircleFillIcon = MinusCircleFillIcon;
dist.MinusCircleLineBoldIcon = MinusCircleLineBoldIcon;
dist.MinusCircleLineIcon = MinusCircleLineIcon;
dist.MinusCircleLineLightIcon = MinusCircleLineLightIcon;
...
dist.NotificationLineBoldIcon = NotificationLineBoldIcon;
dist.NotificationLineIcon = NotificationLineIcon;
dist.NotificationLineLightIcon = NotificationLineLightIcon;
dist.NotificationOffFillIcon = NotificationOffFillIcon;
dist.NotificationOffLineBoldIcon = NotificationOffLineBoldIcon;
dist.NotificationOffLineIcon = NotificationOffLineIcon;
dist.OpenInNewLineIcon = OpenInNewLineIcon;
dist.OptimizationFillIcon = OptimizationFillIcon;
dist.OptimizationLineBoldIcon = OptimizationLineBoldIcon;
dist.OptimizationLineIcon = OptimizationLineIcon;
dist.OptimizationLineLightIcon = OptimizationLineLightIcon;
dist.PlayCircleFillIcon = PlayCircleFillIcon;
dist.PlayCircleLineIcon = PlayCircleLineIcon;
dist.PlayFillIcon = PlayFillIcon;
dist.PlayLineIcon = PlayLineIcon;
...
dist.ProgressCircleFillIcon = ProgressCircleFillIcon;
dist.ProgressCircleLineBoldIcon = ProgressCircleLineBoldIcon;
dist.ProgressCircleLineIcon = ProgressCircleLineIcon;
dist.ProgressCircleLineLightIcon = ProgressCircleLineLightIcon;
dist.ProgressLineBoldIcon = ProgressLineBoldIcon;
dist.ProgressLineIcon = ProgressLineIcon;
dist.ProgressLineLightIcon = ProgressLineLightIcon;
dist.RefreshLineBoldIcon = RefreshLineBoldIcon;
dist.RefreshLineIcon = RefreshLineIcon;
dist.RefreshLineLightIcon = RefreshLineLightIcon;
...
dist.ShareFillIcon = ShareFillIcon;
dist.ShareLineBoldIcon = ShareLineBoldIcon;
dist.ShareLineIcon = ShareLineIcon;
dist.ShareLineLightIcon = ShareLineLightIcon;
dist.SlamFillIcon = SlamFillIcon;
dist.SlamLineBoldIcon = SlamLineBoldIcon;
dist.SlamLineIcon = SlamLineIcon;
dist.SlamLineLightIcon = SlamLineLightIcon;
...
dist.SyncLineBoldIcon = SyncLineBoldIcon;
dist.SyncLineIcon = SyncLineIcon;
dist.SyncLineLightIcon = SyncLineLightIcon;
dist.TableViewFillIcon = TableViewFillIcon;
dist.TableViewLineBoldIcon = TableViewLineBoldIcon;
dist.TableViewLineIcon = TableViewLineIcon;
dist.TableViewLineLightIcon = TableViewLineLightIcon;
...
dist.UploadCircleFillIcon = UploadCircleFillIcon;
dist.UploadCircleLineBoldIcon = UploadCircleLineBoldIcon;
dist.UploadCircleLineIcon = UploadCircleLineIcon;
dist.UploadCircleLineLightIcon = UploadCircleLineLightIcon;
dist.UploadLineIcon = UploadLineIcon;
...
dist.VpsFillIcon = VpsFillIcon;
dist.VpsLineBoldIcon = VpsLineBoldIcon;
dist.VpsLineIcon = VpsLineIcon;
dist.VpsLineLightIcon = VpsLineLightIcon;
...
var Accordion = function (_a) {
    var width = _a.width, items = _a.items, expandIcon = _a.expandIcon, defaultSelectItem = _a.defaultSelectItem, _b = _a.expandControl, expandControl = _b === void 0 ? true : _b, _c = _a.showExpandIcon, showExpandIcon = _c === void 0 ? true : _c;
    var _d = React$1.useState(false), isOpenBody = _d[0], setIsOpenBody = _d[1];
    var _e = React$1.useState(null), openBody = _e[0], setOpenBody = _e[1];
    var _f = React$1.useState(0), height = _f[0], setHeight = _f[1];
    var _g = React$1.useState(), clickItem = _g[0], setClickItem = _g[1];
    var onClickHead = function (e, clickId) {
        if (!e.target.classList.contains('disabled') && expandControl) {
            var clickIditem = document.getElementById("".concat(clickId, "-item"));
    ...
    React$1.useEffect(function () {
        if (defaultSelectItem) {
            var defaultSelectMenu = document.getElementById("".concat(defaultSelectItem, "-item"));
    ...
    React$1.useEffect(function () {
        var allItem = document.querySelectorAll('.mds-accordion__item_body');
        for (var _i = 0, allItem_1 = allItem; _i < allItem_1.length; _i++) {
            var item = allItem_1[_i];
            item.style.height = '0';
        }
        if (clickItem) {
            if (isOpenBody) {
                clickItem.style.height = "".concat(height, "px");
            }
            else {
    ...
    return (React__default["default"].createElement("div", { className: "mds-accordion-wrap", style: { width: width ? width : '100%' } }, items.map(function (itemData) {
        return (React__default["default"].createElement("div", { key: itemData.id, className: [
                'mds-accordion__item',
            ...
            React__default["default"].createElement("div", { id: itemData.id + '-head', className: [
                ...
                typeof itemData.head === 'string' ? (React__default["default"].createElement(Title, { role: 3, type: "title", size: "xs" }, itemData.head)) : (itemData.head),
                React__default["default"].createElement("div", { className: [
                        'accordion-icon',
                        openBody === itemData.id && isOpenBody ? 'open' : 'close',
                    ].join(' ') }, showExpandIcon &&
                    (expandIcon ? expandIcon : React__default["default"].createElement(ArrowDownLineIcon_1, null)))),
            React__default["default"].createElement("div", { id: itemData.id + '-item', className: [
                    'mds-accordion__item_body',
                    openBody === itemData.id && isOpenBody ? 'open' : 'close',
                ].join(' ') }, itemData.contents)));
    })));
};

function Text(_a) {
    var role = _a.role, _b = _a.type, type = _b === void 0 ? 'body' : _b, size = _a.size, innerHtml = _a.innerHtml, className = _a.className, children = _a.children;
...
var Button = function (_a) {
    ...
    return (React__default["default"].createElement("button", __assign({ id: id ? id : '', type: props.htmlType ? props.htmlType : 'button', className: [
            ...
            "".concat(isActionMode && type === 'primary' && size === 'xl'
                ...
                : ''),
            className && className,
        ].join(' '), disabled: state === 'disabled', style: {
            width: "".concat(buttonWidthStyle ? buttonWidthStyle : 'none'),
        } }, props), loading ? (React__default["default"].createElement(Spinner, { color: ['primary', 'secondary', 'error'].includes(type) ? 'white' : 'black' })) : (React__default["default"].createElement(React__default["default"].Fragment, null,
        iconLeft && iconLeft,
    ...
    return (React__default["default"].createElement("div", { className: [
        ...
        React__default["default"].createElement("div", { className: "alert__left-box" },
            ...
            title ? (React__default["default"].createElement("div", { className: "alert__text-box" },
                React__default["default"].createElement(Title, { role: 4, type: "title", size: "xs", className: "font-title" }, title),
...
var MenuItem = function (_a) {
    var id = _a.id, label = _a.label, size = _a.size, iconLeft = _a.iconLeft, iconRight = _a.iconRight, disabled = _a.disabled, subLabel = _a.subLabel, onChange = _a.onChange, onClick = _a.onClick, selected = _a.selected, className = _a.className;
    ...
    return (React__default["default"].createElement("div", { className: [
            ...
            selected ? 'selected' : '',
            className ? className : '',
        ].join(' '), id: id, onClick: function () { return resolveOnClick({ id: id, label: label }); } },
        iconLeft && iconLeft,
        React__default["default"].createElement(Text, { className: "menu__label", type: "body", size: 'l' }, label),
        subLabel && (React__default["default"].createElement(TextLabel, { className: "menu__sub-label", size: "m" }, subLabel)),
        iconRight && iconRight));
};

var Menu = function (_a) {
    var id = _a.id, size = _a.size, itemData = _a.itemData, onClick = _a.onClick, onChange = _a.onChange, className = _a.className, multiple = _a.multiple, selectMenu = _a.selectMenu, _b = _a.hasMaxHeight, hasMaxHeight = _b === void 0 ? true : _b;
    var menuRef = React$1.useRef(null);
    var _c = React$1.useState(''), selectMenuId = _c[0], setSelectMenuId = _c[1];
    var _d = React$1.useState([]), selectMenus = _d[0], setSelectMenus = _d[1];
    var _e = React$1.useState([]), openedMenus = _e[0], setOpenedMenus = _e[1];
    var onSelectDataFilter = function (_a) {
        var id = _a.id, label = _a.label;
        if (menuRef.current) {
            var child = menuRef.current.children;
            var thisMenuEl = menuRef.current.querySelector('#' + id);
            for (var i = 0; i < child.length; i++) {
                var thisMenuElSubList = thisMenuEl === null || thisMenuEl === void 0 ? void 0 : thisMenuEl.nextElementSibling;
                if (thisMenuElSubList != null || thisMenuElSubList != undefined) {
                    ...
                    if (multiple) {
                        var selectData = __spreadArray(__spreadArray([], selectMenus, true), [{ id: id, label: label }], false);
                        var filterSelectData = selectData.reduce(function (acc, current) {
                            var x = acc.find(function (item, s) { return item.id === current.id; });
                            if (!x) {
                                return acc.concat([current]);
                            }
                            else {
                                return acc.filter(function (item) { return item.id !== current.id; });
                            }
                        }, []);
    ...
    var openMenuFilter = function (menuId) {
        if (menuRef.current) {
            var child = menuRef.current.children;
            var thisMenuEl = menuRef.current.querySelector('#' + menuId);
            var thisMenuElSubList_1 = thisMenuEl === null || thisMenuEl === void 0 ? void 0 : thisMenuEl.nextElementSibling;
            for (var i = 0; i < child.length; i++) {
                // sub menu 있는 depth click 시
                if (thisMenuElSubList_1 != null || thisMenuElSubList_1 != undefined) {
                    if (thisMenuElSubList_1.className.includes('close')) {
                        if (thisMenuElSubList_1.id.includes('depth-02-wrap')) {
                            setOpenedMenus([thisMenuElSubList_1.id]);
                        }
                        else if (thisMenuElSubList_1.id.includes('depth-03-wrap')) {
                            setOpenedMenus(__spreadArray(__spreadArray([], openedMenus, true), [thisMenuElSubList_1.id], false));
                        }
                    }
                    else if (thisMenuElSubList_1.className.includes('open')) {
                        if (thisMenuElSubList_1.id.includes('depth-02-wrap')) {
                            setOpenedMenus([]);
                        }
                        else if (thisMenuElSubList_1.id.includes('depth-03-wrap')) ;
                        var filterOpenMenu = openedMenus.filter(function (x) { return x !== thisMenuElSubList_1.id; });
                        setOpenedMenus(filterOpenMenu);
                    }
                }
                else {
                    // sub menu 없는 depth 2 click시
                    if (thisMenuEl === null || thisMenuEl === void 0 ? void 0 : thisMenuEl.className.includes('depth-02')) {
                        var filterOpenMenu = openedMenus.filter(function (x) { return !x.includes('depth-03-wrap'); });
                        setOpenedMenus(filterOpenMenu);
                    }
                    else if (!(thisMenuEl === null || thisMenuEl === void 0 ? void 0 : thisMenuEl.className.includes('depth-03'))) {
                        setOpenedMenus([]);
                    }
                }
            }
    ...
    var onChangeMenu = function (id, label) {
        if (!onChange) {
            return;
        }
        else {
    ...
    var onClickMenu = function (id, label) {
        openMenuFilter(id);
        if (!multiple) {
            setSelectMenuId(id);
        }
    ...
    var onClickMenuSelectedCheck = function (id) {
        if (multiple) {
            return selectMenus.filter(function (item) { return item.id === id; }).length === 1
                ? true
                : false;
        }
        else {
    ...
    var openMenuBucket = [];
    var onSelectMenuOpenClose = function (menuId) {
        var _a;
        // 부모 노드 찾기
        var getParents = function (el) {
            var menuWrap = menuRef.current;
            var parents = [];
            for (el; (el = el === null || el === void 0 ? void 0 : el.parentNode) && el !== menuWrap;) {
                parents.push(el);
            }
            return parents.filter(function (x) { return x === null || x === void 0 ? void 0 : x.classList.contains('menu-wrap'); });
        };
        // 선택 메뉴 감지하여 부모 depth open
        var selectedMenuEl = (_a = menuRef.current) === null || _a === void 0 ? void 0 : _a.querySelector('#' + String(menuId));
        var parentsList = getParents(selectedMenuEl);
        for (var _i = 0, parentsList_1 = parentsList; _i < parentsList_1.length; _i++) {
            var v = parentsList_1[_i];
            v.id && openMenuBucket.push(v.id);
        }
        parentsList.map(function (listItem) {
    ...
    return (React__default["default"].createElement("div", { className: [
        ...
        ].join(' '), id: id + '-menu-wrap', ref: menuRef }, itemData.map(function (item) { return (React__default["default"].createElement("div", { key: item.id, className: "depth-01-wrap" },
        React__default["default"].createElement(MenuItem, { id: item.id, size: size ? size : 'l', label: item.label, subLabel: item === null || item === void 0 ? void 0 : item.subLabel, iconLeft: item === null || item === void 0 ? void 0 : item.iconLeft, iconRight: item.subItemData ? React__default["default"].createElement(ArrowDownLineIcon_1, null) : item === null || item === void 0 ? void 0 : item.iconRight, disabled: item.disabled, onChange: onChangeMenu, onClick: function () { return onClickMenu(item.id, item.label); }, selected: onClickMenuSelectedCheck(item.id), className: [
                '',
                openedMenus.includes(item.id + '-depth-02-wrap')
                    ? 'sub-menu-open'
                    : 'sub-menu-close',
            ].join(' ') }),
        item.subItemData && (React__default["default"].createElement("div", { className: [
                'menu-wrap',
                'depth-02-wrap',
                openedMenus.includes(item.id + '-depth-02-wrap')
                    ? 'open'
                    : 'close',
            ].join(' '), id: item.id + '-depth-02-wrap' }, item.subItemData.map(function (subItem) { return (React__default["default"].createElement("div", { key: subItem.id },
            React__default["default"].createElement(MenuItem, { id: subItem.id, size: 's', label: subItem.label, subLabel: subItem === null || subItem === void 0 ? void 0 : subItem.subLabel, iconLeft: subItem === null || subItem === void 0 ? void 0 : subItem.iconLeft, iconRight: subItem.subItemData ? (React__default["default"].createElement(ArrowDownLineIcon_1, null)) : (subItem === null || subItem === void 0 ? void 0 : subItem.iconRight), disabled: subItem.disabled, onChange: onChangeMenu, onClick: function () { return onClickMenu(subItem.id, subItem.label); }, selected: onClickMenuSelectedCheck(subItem.id), className: [
                    'depth-02',
            ...
            subItem.subItemData && (React__default["default"].createElement("div", { className: [
                    'menu-wrap',
                    'depth-03-wrap',
                    openedMenus.includes(item.id + '-depth-03-wrap')
                        ? 'open'
                        : 'close',
                ].join(' '), id: item.id + '-depth-03-wrap' }, subItem.subItemData.map(function (subItem) { return (React__default["default"].createElement("div", { key: subItem.id },
                React__default["default"].createElement(MenuItem, { id: subItem.id, size: 's', label: subItem.label, subLabel: subItem === null || subItem === void 0 ? void 0 : subItem.subLabel, iconLeft: subItem === null || subItem === void 0 ? void 0 : subItem.iconLeft, iconRight: subItem.subItemData ? (React__default["default"].createElement(ArrowDownLineIcon_1, null)) : (subItem === null || subItem === void 0 ? void 0 : subItem.iconRight), disabled: subItem.disabled, onChange: onChangeMenu, onClick: function () {
                        return onClickMenu(subItem.id, subItem.label);
                    }, selected: onClickMenuSelectedCheck(subItem.id), className: "depth-03" }))); }))))); }))))); })));
};

function AutoComplete(_a) {
    var id = _a.id, size = _a.size, className = _a.className, menuData = _a.menuData, onClick = _a.onClick, onChange = _a.onChange, children = _a.children;
    var autoCompleteRef = React$1.useRef(null);
    var _b = React$1.useState([]), autoCompleteMenuDatas = _b[0], setAutoCompleteMenuData = _b[1];
    var _c = React$1.useState(menuData); _c[0]; _c[1];
    var _d = React$1.useState(false), menuOpen = _d[0], setMenuOpen = _d[1];
    var _e = React$1.useState(''), selectValue = _e[0], setSelectValue = _e[1];
    var onChangeChildren = function (value) {
        var filteringData = menuData.filter(function (itemData) {
            return itemData.label.toLowerCase().indexOf(value.toLowerCase()) > -1;
        });
    ...
    var onClickChildren = function (e) {
        setMenuOpen(true);
        if (!onClick) {
            return;
        }
    ...
    React$1.useEffect(function () {
        if (menuOpen) {
            var thisAutoCompleteMenuWrap = document.getElementById("".concat(id, "-menu-wrap"));
            var thisBaseWrap = document.getElementById("".concat(id, "__base"));
    ...
    return (React__default["default"].createElement("div", { className: ['mds-autocomplete', className ? className : ''].join(' '), ref: autoCompleteRef },
        React__default["default"].createElement("div", { className: "autocomplete__base", onClick: onClickChildren, id: id + '__base' }, React__default["default"].Children.map(children, function (child) {
            return React__default["default"].cloneElement(child, {
                value: selectValue,
                onChange: onChangeChildren,
            });
        })),
        menuOpen && (React__default["default"].createElement("div", { className: ['autocomplete__menu-wrap'].join(' '), id: id + '-menu-wrap' },
            React__default["default"].createElement(Menu, { id: id + '-menu', itemData: autoCompleteMenuDatas, size: size, onClick: onMenuClick })))));
}

var Badge = function (_a) {
    var type = _a.type, size = _a.size, _b = _a.align, align = _b === void 0 ? 'top-right' : _b, color = _a.color, status = _a.status, children = _a.children, number = _a.number, icon = _a.icon, onClick = _a.onClick;
    ...
    return (React__default["default"].createElement("div", { className: ['mds-badge-wrap'].join(' ') },
        React__default["default"].createElement("div", { className: [
                'mds-badge',
                "badge-".concat(type, "-").concat(color ? color : status ? status : 'mint', "-").concat(size),
                align ? align : 'top-right',
                type === 'icon' && onClick ? 'click-mode' : '',
            ].join(' '), onClick: resolveOnClick },
            type == 'number' && (number || number === 0) && (React__default["default"].createElement(TextLabel, { size: ((size == 's' || size == 'm') && 's') || 'm' }, number)),
            type == 'icon' && icon && icon),
        children));
};

var BoxGroup = function (_a) {
    var _b = _a.align, align = _b === void 0 ? 'left' : _b, _c = _a.direction, direction = _c === void 0 ? 'horizontal' : _c, _d = _a.gap, gap = _d === void 0 ? 0 : _d, _e = _a.wrap, wrap = _e === void 0 ? false : _e, children = _a.children;
    return (React__default["default"].createElement("div", { className: ['mds-box-group', "box-group-".concat(align, "-").concat(direction)].join(' '), style: { gap: gap, flexWrap: wrap ? 'wrap' : 'nowrap' } }, children));
};

var Dropdown = function (_a) {
    var id = _a.id, size = _a.size, align = _a.align, children = _a.children, menuData = _a.menuData, onClick = _a.onClick, onChange = _a.onChange, isFullWidthMenu = _a.isFullWidthMenu, className = _a.className, multiple = _a.multiple, menuDirection = _a.menuDirection, selectMenu = _a.selectMenu;
    ...
    var _d = React$1.useState(''), selectId = _d[0], setSelectId = _d[1];
    var _e = React$1.useState([]), multiSelectData = _e[0], setMultiSelectData = _e[1];
    var onClickDropdownBase = function () {
        if (menuOpen) {
            setMenuOpen(false);
        }
        else {
    ...
    var onChangeDropdownMenu = function (data) {
        var id = data.id, label = data.label;
        if (!onChange) {
            return;
        }
        else {
    ...
    var onClickDropdownMenu = function (data) {
        var id = data.id, label = data.label;
        if (menuRef.current) {
            if (multiple) {
    ...
    return (React__default["default"].createElement("div", { className: [
        ...
        React__default["default"].createElement("div", { className: "dropdown-box__base", onClick: onClickDropdownBase, id: id + '__base' }, children),
        menuOpen && (React__default["default"].createElement("div", { className: [
                'dropdown-box__menu-wrap',
                isFullWidthMenuWrap ? 'full-width' : '',
            ].join(' '), id: id + '-menu-wrap', ref: menuRef },
            React__default["default"].createElement(Menu, { id: id + 'menu', size: size, itemData: menuData, onChange: onChangeDropdownMenu, onClick: onClickDropdownMenu, multiple: multiple, selectMenu: multiple ? multiSelectData : selectId })))));
};
...
var Breadcrumb = function (_a) {
    ...
    var _c = React$1.useState(null), thisPageIndex = _c[0], setThisPageIndex = _c[1];
    React$1.useEffect(function () {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null, buttonData.subMenu ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Dropdown, { id: "".concat(buttonData.id, "-dropdown"), size: "s", align: "left", menuData: buttonData.subMenu, className: "breadcrumb-dropdown-box", onClick: buttonData.onMoveSubPage && buttonData.onMoveSubPage },
                React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(Button, { state: buttonData.disabled ? 'disabled' : 'default', type: "ghost", size: "s", iconLeft: buttonData.icon && buttonData.icon, iconRight: React__default["default"].createElement(ArrowDownCircleLineIcon_1, null), className: [
                            thisPage === buttonData.id ? 'current' : 'default',
                        ].join(' '), onClick: buttonData.onMovePage && buttonData.onMovePage }, buttonData.label))))) : (React__default["default"].createElement(Button, { state: buttonData.disabled ? 'disabled' : 'default', type: "ghost", size: "s", iconLeft: buttonData.icon && buttonData.icon, className: [
                thisPage === buttonData.id ? 'current' : 'default',
...
function Checkbox(_a) {
    var id = _a.id, type = _a.type, mode = _a.mode, state = _a.state, size = _a.size, disabled = _a.disabled, label = _a.label, helperText = _a.helperText, checked = _a.checked, onChange = _a.onChange, onClick = _a.onClick;
    ...
    return (React__default["default"].createElement("div", { className: ['checkbox-wrap'].join(' ') },
        label ? (React__default["default"].createElement("label", { htmlFor: id, className: ['', 'checkbox-label'].join(' ') },
            React__default["default"].createElement("span", { className: [
                    'checkbox',
                    "checkbox__".concat(size, "--").concat((disabled && 'disabled') || thisState, "__").concat(mode ? mode : 'primary'),
        ...
        helperText && (React__default["default"].createElement(Text, { type: "body", size: "s", className: [
            ...
            thisState === 'error' && (React__default["default"].createElement("span", { className: "icon-error" },
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: [
            ...
            helperText && (React__default["default"].createElement(Text, { type: "body", size: "s", className: ['helper-text', (disabled && 'disabled') || state].join(' ') },
                state === 'error' && (React__default["default"].createElement("span", { className: "icon-error" },
                    React__default["default"].createElement(ErrorCircleLineBoldIcon_1, null))),
                React__default["default"].createElement("span", { className: "text" }, helperText))))));
};
...
var Chip = function (_a) {
    ...
    return (React__default["default"].createElement("div", __assign({ role: action && 'button', tabIndex: action ? 0 : -1, onClick: resolveOnClick, onChange: resolveOnChange, className: [
        ...
        React__default["default"].createElement(TextLabel, { size: (size === 'xl' && 'l') || (size === 's' && 's') || 'm' }, children),
...
var Container = function (_a) {
    var full = _a.full, className = _a.className, maxWidth = _a.maxWidth, align = _a.align, children = _a.children, props = __rest(_a, ["full", "className", "maxWidth", "align", "children"]);
    return (React__default["default"].createElement("div", __assign({ className: [
            'mds-container',
            full && 'full',
            align ? align : 'center',
            className && className,
        ].join(' '), style: { maxWidth: maxWidth } }, props), children));
};
...
var Drawer = function (_a) {
    var width = _a.width, header = _a.header, footer = _a.footer, _b = _a.position, position = _b === void 0 ? 'left' : _b, children = _a.children, _c = _a.isCloseButton, isCloseButton = _c === void 0 ? true : _c, open = _a.open, onClose = _a.onClose, closeButtonIcon = _a.closeButtonIcon, _d = _a.isDim, isDim = _d === void 0 ? true : _d;
    ...
    return (React__default["default"].createElement("div", { className: ['mds-drawer-wrap', open ? 'open' : 'close'].join(' ') },
        isDim && React__default["default"].createElement("div", { className: "dim", onClick: onClickClose }),
        React__default["default"].createElement("div", { className: [
                'mds-drawer',
                position ? position : 'left',
                open ? 'open' : 'close',
            ].join(' '), style: { width: width ? width : 'none' } },
            isCloseButton && (React__default["default"].createElement(Button, { size: 'xl', type: 'ghost', iconOnly: closeButtonIcon ? closeButtonIcon : React__default["default"].createElement(CloseLineIcon_1, null), isIconMode: true, className: "mds-drawer__close-button", onClick: onClickClose })),
            header && React__default["default"].createElement("div", { className: "mds-drawer__header" }, header),
            React__default["default"].createElement("div", { className: "mds-drawer__body" }, children),
            footer && React__default["default"].createElement("div", { className: "mds-drawer__footer" }, footer))));
};
...
var Switch = function (_a) {
    var id = _a.id, iconMode = _a.iconMode, size = _a.size, state = _a.state, label = _a.label, className = _a.className, checked = _a.checked, disabled = _a.disabled, helperText = _a.helperText, checkOffIcon = _a.checkOffIcon, checkOnIcon = _a.checkOnIcon, onClick = _a.onClick;
    var _b = React$1.useState(false), isChecked = _b[0], setIsChecked = _b[1];
    ...
    return (React__default["default"].createElement("div", { className: [
        ...
        React__default["default"].createElement("label", { htmlFor: id, className: [
                'switch-toggle',
                "switch-toggle__".concat(size ? size : 'l', "--").concat((disabled && 'disabled') || thisState),
                isChecked ? 'checked' : '',
                className ? className : '',
            ].join(' '), onClick: resolveOnClick },
            React__default["default"].createElement("input", { id: id, type: "checkbox", disabled: disabled || thisState === 'disabled', defaultChecked: checked }),
            React__default["default"].createElement("span", { className: "switch-button" }, iconMode &&
                (isChecked ? (checkOnIcon ? (checkOnIcon) : (React__default["default"].createElement(CheckLineBoldIcon_1, null))) : checkOffIcon ? (checkOffIcon) : (React__default["default"].createElement(CloseLineBoldIcon_1, null)))),
    ...
    return (React__default["default"].createElement("li", { className: ['mds-list-box', alignTop ? 'top' : 'center'].join(' ') },
        React__default["default"].createElement("div", { className: "mds-list__left-box", id: "mds-list__left-box-".concat(id) },
            ...
            React__default["default"].createElement("div", { className: "mds-list__text-box" },
                React__default["default"].createElement(Title, { role: 4, type: "title", size: "xs" }, title),
...
var Modal = function (_a) {
    var id = _a.id, title = _a.title, titleImage = _a.titleImage, titleIcon = _a.titleIcon, children = _a.children, size = _a.size, mainButton = _a.mainButton, subButton = _a.subButton, subtlestButton = _a.subtlestButton, isCloseButton = _a.isCloseButton, open = _a.open, onClose = _a.onClose;
    ...
    return (React__default["default"].createElement("div", { className: ['modal-wrap', open ? 'open' : 'close'].join(' ') },
        ...
        React__default["default"].createElement("div", { id: id, className: ['modal-box', "modal__".concat(size ? size : 's')].join(' ') },
            ...
            title && (React__default["default"].createElement("div", { className: "modal-header" },
                ...
                React__default["default"].createElement(Title, { type: "title", size: "s", role: 2 }, title))),
            ...
            isFooter && (React__default["default"].createElement("div", { className: "modal-footer" },
                React__default["default"].createElement(ButtonGroup, { fullWidth: true },
                    subtlestButton && (React__default["default"].createElement(Button, { type: "ghost", size: "l", onClick: subtlestButton.onClick }, subtlestButton.text)),
                    subButton && (React__default["default"].createElement(Button, { type: "tertiary", size: "l", onClick: subButton.onClick }, subButton.text)),
                    mainButton && (React__default["default"].createElement(Button, { type: mainButton.type, size: "l", onClick: mainButton.onClick }, mainButton.text))))))));
};
...
var Pagination = function (_a) {
    var smallWidth = _a.smallWidth, simpleMode = _a.simpleMode, size = _a.size, align = _a.align, 
    // totalCount,
    totalPage = _a.totalPage, defaultPage = _a.defaultPage, disabled = _a.disabled, showFirstButton = _a.showFirstButton, showLastButton = _a.showLastButton, showPageSizeChanger = _a.showPageSizeChanger, onshowPageSizeChange = _a.onshowPageSizeChange, showPageOptionCustom = _a.showPageOptionCustom, onClick = _a.onClick;
    var _b = React$1.useState(1), thisPage = _b[0], setThisPage = _b[1];
    var _c = React$1.useState({
        id: 'page-size-10',
        label: '10 pages',
    }), selectShowPageSizeData = _c[0], setSelectShowPageSizeData = _c[1];
    ...
    var resolveOnshowPageSizeChange = function (selectMenuData) {
        if (selectMenuData) {
    ...
    var paginaionItemFilter = function (node) {
        ...
        var moreButtonDraw = function (type) { return (React__default["default"].createElement("li", { key: "pagination-button-more-".concat(type) },
            React__default["default"].createElement(Button, { type: "ghost", state: disabled ? 'disabled' : 'default', size: buttonSizeFilter(size), id: "pagination-button-more-".concat(type), iconOnly: React__default["default"].createElement(MoreHorizontalLineIcon_1, null), isIconMode: true }))); };
        if (smallWidth) {
            if (node.length >= 7) {
                itemList = [];
                if (thisPage < 4) {
            ...
            if (node.length >= 14) {
                ...
                itemList = [];
                itemList = node.map(function (item, index) {
                    return (React__default["default"].createElement(React$1.Fragment, { key: "pagination-button-".concat(index) }, index < 14 && item));
                });
            }
        }
        return itemList;
        ...
        React__default["default"].createElement("ul", null,
            showFirstButton && (React__default["default"].createElement("li", null,
                React__default["default"].createElement(Button, { type: "ghost", state: (disabled && 'disabled') ||
                        (thisPage === 1 ? 'disabled' : 'default'), size: buttonSizeFilter(size), id: "pagination-button-first", onClick: function () { return resolveOnClick('first', 1); }, isIconMode: true, iconOnly: React__default["default"].createElement(FirstPageLineIcon_1, null) }))),
            React__default["default"].createElement("li", null,
                React__default["default"].createElement(Button, { type: "ghost", size: buttonSizeFilter(size), id: "pagination-button-prev", onClick: function () { return resolveOnClick('prev', thisPage - 1); }, isIconMode: true, iconOnly: React__default["default"].createElement(ArrowLeftLineIcon_1, null), state: (disabled && 'disabled') ||
            ...
            React__default["default"].createElement("li", null,
                React__default["default"].createElement(Button, { type: "ghost", size: buttonSizeFilter(size), id: "pagination-button-next", onClick: function () { return resolveOnClick('next', thisPage + 1); }, isIconMode: true, iconOnly: React__default["default"].createElement(ArrowRightLineIcon_1, null), state: (disabled && 'disabled') ||
                        (thisPage === totalPage ? 'disabled' : 'default') })),
            showLastButton && (React__default["default"].createElement("li", null,
                React__default["default"].createElement(Button, { type: "ghost", size: buttonSizeFilter(size), id: "pagination-button-last", onClick: function () { return resolveOnClick('last', totalPage); }, isIconMode: true, iconOnly: React__default["default"].createElement(LastPageLineIcon_1, null), state: (disabled && 'disabled') ||
                        (thisPage === totalPage ? 'disabled' : 'default') })))),
        showPageSizeChanger && (React__default["default"].createElement(Dropdown, { size: "s", menuData: showPageOptionCustom ? showPageOptionCustom : pageSizeData, onChange: resolveOnshowPageSizeChange, id: "dropdown-page-size-change", className: "dropdown-page-size-change" },
            React__default["default"].createElement(Button, { type: "ghost", size: buttonSizeFilter(size), iconRight: React__default["default"].createElement(ArrowDownLineIcon_1, null) }, selectShowPageSizeData.label)))));
};

var PositionModal = function (_a) {
    var id = _a.id, title = _a.title, titleImage = _a.titleImage, titleIcon = _a.titleIcon, children = _a.children, size = _a.size, mainButton = _a.mainButton, subButton = _a.subButton, subtlestButton = _a.subtlestButton, isCloseButton = _a.isCloseButton, open = _a.open, onClose = _a.onClose, smallButtonMode = _a.smallButtonMode, _b = _a.isDim, isDim = _b === void 0 ? false : _b, isArrow = _a.isArrow, arrowDirection = _a.arrowDirection, position = _a.position;
    var modalRef = React$1.useRef(null);
    var _c = React$1.useState(false), isFooter = _c[0], setIsFooter = _c[1];
    var onClickClose = function () {
        var bodyEl = document.body;
        bodyEl.style.overflow = "auto";
        onClose();
    ...
    return (React__default["default"].createElement("div", { className: ['modal-wrap', open ? 'open' : 'close'].join(' ') },
        React__default["default"].createElement("div", { className: isDim ? 'dim' : 'dim-transparent', onClick: onClickClose }),
        React__default["default"].createElement("div", { id: id, className: [
                'modal-box',
                "modal__".concat(size ? size : 's'),
                'position-modal',
                isArrow ? 'arrow' : '',
                isArrow && arrowDirection ? arrowDirection : 'top',
                !isDim ? 'shadow' : '',
            ].join(' '), ref: modalRef, style: position },
            isCloseButton && (React__default["default"].createElement("span", { className: "modal-close-button", onClick: onClickClose },
                React__default["default"].createElement(CloseLineIcon_1, null))),
            title && (React__default["default"].createElement("div", { className: "modal-header" },
                titleIcon && titleIcon,
                ...
                React__default["default"].createElement(Title, { type: "title", size: "s", role: 2 }, title))),
            children && (React__default["default"].createElement("div", { className: "modal-body" }, typeof children === 'string' ? (React__default["default"].createElement(Text, { type: "body", size: "m" }, children)) : (children))),
            isFooter && (React__default["default"].createElement("div", { className: [
                    'modal-footer',
                    smallButtonMode ? 'small-button-mode' : '',
                ].join(' ') },
                React__default["default"].createElement(ButtonGroup, { fullWidth: !smallButtonMode, align: "right" },
                    subtlestButton && (React__default["default"].createElement(Button, { type: "ghost", size: smallButtonMode ? 'm' : 'l', onClick: subtlestButton.onClick }, subtlestButton.text)),
                    subButton && (React__default["default"].createElement(Button, { type: "tertiary", size: smallButtonMode ? 'm' : 'l', onClick: subButton.onClick }, subButton.text)),
                    mainButton && (React__default["default"].createElement(Button, { type: mainButton.type, size: smallButtonMode ? 'm' : 'l', onClick: mainButton.onClick }, mainButton.text))))))));
};
...
function TextField(_a) {
    var id = _a.id, _b = _a.type, type = _b === void 0 ? 'text' : _b, value = _a.value, label = _a.label, placeholder = _a.placeholder, required = _a.required, password = _a.password, state = _a.state, size = _a.size, disabled = _a.disabled, helperText = _a.helperText, resetButton = _a.resetButton, minLength = _a.minLength, maxLength = _a.maxLength, multiLine = _a.multiLine, iconLeft = _a.iconLeft, iconRight = _a.iconRight, onChange = _a.onChange, onClick = _a.onClick, renderValue = _a.renderValue, _c = _a.readOnly, readOnly = _c === void 0 ? false : _c; __rest(_a, ["id", "type", "value", "label", "placeholder", "required", "password", "state", "size", "disabled", "helperText", "resetButton", "minLength", "maxLength", "multiLine", "iconLeft", "iconRight", "onChange", "onClick", "renderValue", "readOnly"]);
    var _d = React$1.useState(''), resoleValue = _d[0], setResolveValue = _d[1];
    var _e = React$1.useState('default'), thisState = _e[0], setThisState = _e[1];
    var _f = React$1.useState(false), showResetButton = _f[0], setShowResetButton = _f[1];
    var _g = React$1.useState('text'), thisType = _g[0], setThisType = _g[1];
    var _h = React$1.useState(0), valueLength = _h[0], setValueLength = _h[1];
    var _j = React$1.useState(false), isRenderValueMode = _j[0], setIsRenderValueMode = _j[1];
    ...
    React$1.useEffect(function () {
        if (multiLine && value) {
            ...
            if (typeof maxLength === 'number' && value) {
                var valuefilter = String(value).slice(0, maxLength);
    ...
    return (React__default["default"].createElement("div", { className: [
        ...
        React__default["default"].createElement("div", { className: ['textfield-formControl', multiLine && 'multi-line'].join(' ') },
            ...
            isRenderValueMode &&
                (typeof renderValue === 'string' ? (React__default["default"].createElement("div", { className: "textfield__render-value-box" },
                    React__default["default"].createElement(Text, { type: "body", size: "l" }, renderValue))) : (renderValue)),
            multiLine ? (React__default["default"].createElement("textarea", { readOnly: readOnly, id: id, placeholder: placeholder, disabled: (disabled ? disabled : false) ||
                    (thisState === 'disabled' ? true : false), value: resoleValue ? resoleValue : '', onChange: function (e) { return resolveOnChange(e); }, onFocus: function (e) { return onFocus(); }, onBlur: function (e) { return onBlur(e); }, onClick: onClick })) : (React__default["default"].createElement("input", { readOnly: readOnly, id: id, placeholder: placeholder, type: thisType, disabled: (disabled ? disabled : false) ||
        ...
        (helperText || multiLine) && (React__default["default"].createElement(Text, { type: "body", size: "s", className: "helper-text" },
            thisState === 'error' && (React__default["default"].createElement("span", { className: "icon-error" },
                React__default["default"].createElement(ErrorCircleLineBoldIcon_1, null))),
            thisState === 'success' && (React__default["default"].createElement("span", { className: "icon-success" },
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: ["input__group", fullWidth && 'fullWidth'].join(' ') },
            ...
            helperText && (React__default["default"].createElement(Text, { type: "body", size: "s", className: ['helper-text', (disabled && 'disabled') || state].join(' ') },
                state === 'error' && (React__default["default"].createElement("span", { className: "icon-error" },
                    React__default["default"].createElement(ErrorCircleLineBoldIcon_1, null))),
                state === 'success' && (React__default["default"].createElement("span", { className: "icon-success" },
                    React__default["default"].createElement(CheckCircleLineBoldIcon_1, null))),
                React__default["default"].createElement("span", { className: "text" }, helperText))))));
};

var SearchBar = function (_a) {
    var id = _a.id, size = _a.size, placeholder = _a.placeholder, disabled = _a.disabled, fullWidth = _a.fullWidth, helperText = _a.helperText, resetButton = _a.resetButton, onChange = _a.onChange, value = _a.value, className = _a.className;
    return (React__default["default"].createElement("div", { className: [
            "search-wrap",
            fullWidth && 'fullWidth',
            className && className,
        ].join(' ') },
        React__default["default"].createElement(TextField, { id: id, size: size, placeholder: placeholder, iconLeft: React__default["default"].createElement(SearchLineIcon_1, null), disabled: disabled, onChange: onChange, helperText: helperText, resetButton: resetButton, value: value })));
};

var Sidebar = function (_a) {
    var className = _a.className, header = _a.header, footer = _a.footer, props = __rest(_a, ["className", "header", "footer"]);
...
function Tab(_a) {
    var size = _a.size, widthFixed = _a.widthFixed, selectValue = _a.selectValue, tabData = _a.tabData, secondaryMode = _a.secondaryMode, className = _a.className;
    var tabBarRef = React$1.useRef(null);
    var tabBarListRef = React$1.useRef(null);
    var prevButtonRef = React$1.useRef(null);
    var nextButtonRef = React$1.useRef(null);
    ...
    var onChickControlButton = function (type) {
        var tabBar = tabBarRef.current;
        var tabBarList = tabBarListRef.current;
        var tabBarWidth = tabBar.clientWidth;
        var tabBarListWidth = tabBarList.clientWidth;
        var tabControlPrev = prevButtonRef.current;
        var tabControlNext = nextButtonRef.current;
        if (type === 'next') {
    ...
    React$1.useEffect(function () {
        ...
        var tabControlNext = nextButtonRef.current;
        if (tabBarList) {
            var tabBarWidth = tabBarRef.current.clientWidth;
            var tabBarListWidth = tabBarListRef.current.clientWidth;
    ...
    return (React__default["default"].createElement("div", { className: [
        ...
        React__default["default"].createElement("div", { className: [
            ...
            React__default["default"].createElement("div", { className: "control prev", ref: prevButtonRef },
            ...
            React__default["default"].createElement("div", { className: "tab-bar__list", ref: tabBarListRef }, tabData.map(function (tabitem) {
                return secondaryMode ? (React__default["default"].createElement("button", { className: [
                        'tab__secondary-mode',
                        "tab-secondary-".concat(onTabStateFilter(tabitem.state)),
                    ...
                    React__default["default"].createElement(TextLabel, { size: 'l' }, tabitem.label))) : (React__default["default"].createElement("button", { className: [
            ...
            React__default["default"].createElement("div", { className: "control next", ref: nextButtonRef },
...
var Table = function (_a) {
    var id = _a.id, size = _a.size, align = _a.align, columnData = _a.columnData, rowData = _a.rowData, tableMinWidth = _a.tableMinWidth, verticalHeadingMode = _a.verticalHeadingMode, leftHeadRow = _a.leftHeadRow, checkMode = _a.checkMode, _b = _a.isRowCheck, isRowCheck = _b === void 0 ? false : _b, onClick = _a.onClick, onCheck = _a.onCheck;
    ...
    var _j = React$1.useState(''), sortId = _j[0], setSortId = _j[1];
    var _k = React$1.useState(''), sortDirection = _k[0], setSortDirection = _k[1];
    ...
    var resolveOnClick = function (rowdata, rowid) {
        if (!onClick) {
            return;
        }
        onClick(rowdata, rowid);
    };
    var resolveOnCheck = function (rowdata, rowid) {
        if (!onCheck) {
            return;
        }
    ...
    var onCheckedOne = function (rowItem, rowid) {
        var checkItems = __spreadArray([], checkItemList, true);
    ...
    var onCheckedRow = function (e, rowItem, rowid) {
        var clickRowCheckbox = document.getElementById("".concat(rowid));
    ...
    return (React__default["default"].createElement("div", { className: "mds-table-wrap" },
        React__default["default"].createElement("table", { id: id, className: [
                    ...
                    columnData.map(function (columnItem) {
                        return (React__default["default"].createElement("th", { className: [
                            ...
                            React__default["default"].createElement("div", { className: "th__content-wrap" },
                                ...
                                columnItem.sort && (React__default["default"].createElement(Button, { type: "ghost", size: "xs", iconOnly: React__default["default"].createElement(SortLineBoldIcon_1, null), isIconMode: true, onClick: function () { return onChickSort(columnItem.id); }, className: [
                                        'sort-icon',
            ...
            React__default["default"].createElement("tbody", null, rowDataSource.length !== 0 ? (rowDataSource.map(function (rowItem, rowItemIndex) {
                return (React__default["default"].createElement("tr", { key: String(rowItem.id), className: [
                        checkMode && checkItemList.includes(rowItem.id)
                            ? 'selected'
                            : '',
                    ].join(' ') },
                    verticalHeadingMode ? (React__default["default"].createElement("th", { id: columnData[rowItemIndex].id, onClick: function (e) {
                            return onCheckedRow(e, rowItem, String(rowItem.id));
                        } },
                        ...
                        React__default["default"].createElement(Checkbox, { id: String(rowItem.id), size: 's', onClick: function (e) { return onCheckedOne(rowItem, e.id); }, checked: checkItemList.includes(rowItem.id) })))),
                    cellKey.map(function (cellKeyItem, cellKeyIndex) {
                        return cellKeyIndex === 0 && leftHeadRow ? (React__default["default"].createElement("th", { onClick: function (e) {
                                return onCheckedRow(e, rowItem, String(rowItem.id));
                            }, className: [
                            ...
                            React__default["default"].createElement(TextLabel, { size: "m" }, rowItem[cellKeyItem]))) : (React__default["default"].createElement("td", { onClick: function (e) {
                                return onCheckedRow(e, rowItem, String(rowItem.id));
                            }, className: [
                                cellAlign[cellKeyIndex] !== 'left'
                                    ? cellAlign[cellKeyIndex]
