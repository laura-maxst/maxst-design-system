...
const meta: Meta<typeof Tab> = {
  ...
  argTypes: {
    ...
    secondaryMode: {
      description:
        'secondary mode의 tab 사용시 boolean값으로 지정합니다. tab내부에 tab이 필요할 경우 사용하는 것을 권장합니다.',
    },
    widthFixed: {
      description:
        'tab button들이 tab의 width 100%를 넘지 않을 시에는 tab의 width에 맞춰 비율로 늘어나고, tab의 width 100%를 넘을 시에는 모든 tab button의 width가 일정하게 맞춰지는 옵션입니다. secondary mode에서는 적용되지 않습니다.',
    },
    size: {
