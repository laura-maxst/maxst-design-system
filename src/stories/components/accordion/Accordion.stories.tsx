...
const meta: Meta<typeof Accordion> = {
  ...
  argTypes: {
    ...
    expandControl: {
      description:
        'accordion의 펼침 기능 제어 옵션입니다. 기본적으로 true를 제공합니다. defaultSelectItem과 함께 사용하여 원하는 menu만 펼쳐놓고 control을 하지 못하도록 제어할 수 있습니다.',
    },
    showExpandIcon: {
      description:
        'expand icon의 show 유무 지정 옵션입니다. 기본적으로 true를 제공하고 expand icon을 가리고 싶을 시 false로 지정해줍니다.',
    },
  },
};
